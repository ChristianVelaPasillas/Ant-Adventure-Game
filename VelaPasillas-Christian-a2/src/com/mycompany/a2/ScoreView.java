...
public class ScoreView extends Container implements Observer{ // Define a ScoreView class that extends Container and implements Observer
	...
	public ScoreView() { // Constructor for the ScoreView
		
		this.setLayout(new FlowLayout(Component.CENTER)); // Set layout to FlowLayout
