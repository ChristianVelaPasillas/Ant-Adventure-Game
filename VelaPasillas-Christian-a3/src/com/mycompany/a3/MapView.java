...
//MapView class extends Container and implements Observer
public class MapView extends Container implements Observer{
	...
	public MapView() {
		...
		// Initializing the height and width of the map view.
		...
		while(itr.hasNext()) {
			...
			if(tempObject instanceof ISelectable) {
				...
				if(selectObject.contains(pPtrRelPrnt, pCmpRelPrnt)) {
					...
					selectObject.setSelected(false); // Deselecting the object.
				}
			}
		}
		repaint(); // Repainting the view to reflect any changes.
		gw.notifyObservers(this); // Notifying observers of the change.
	}
