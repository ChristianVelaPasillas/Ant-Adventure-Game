...
public class ScoreView extends Container implements Observer{
	...
	public ScoreView() { // Constructor for ScoreView.
		
		this.setLayout(new FlowLayout(Component.CENTER)); // Setting the layout of the ScoreView container.
	 ...
	 */
	private void gameClock() { //Initialization for the time clock label.
	 ...
	 */
	private void playerLives() { // Initialization for the player lives label.
	 ...
	 */
	private void lastFlagReached() { //Initialization for the last flag reached label.
	 ...
	 */
	private void foodLevel() { //Initialization for the food level label.
	 ...
	 */
	private void healthLevel() { //Initialization for the health level label.
	 ...
	 */
	private void setSound() { //Initialization for the sound setting label.
