...
public abstract class GameObject implements IDrawable, ICollider {
	...
	// Location and color properties for any game object.
	private double locationX;
	private double locationY;
	private int rgb;
	private int size;
	private Point location; // A Point object to hold X and Y coordinates.
	
	//Sets up the initial state of a game object.
	public GameObject() {
		// Setting random locations for the object.
		this.setLocationX(getRandom(1000));
		this.setLocationY(getRandom(1000));
		
		// Creating a Point object to represent	
