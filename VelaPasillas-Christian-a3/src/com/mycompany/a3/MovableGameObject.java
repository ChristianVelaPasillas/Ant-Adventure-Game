...
public abstract class MovableGameObject extends GameObject{
	...
	private int objectSpeed = 0; // Speed of the object.
	private int objectDirection; // Direction the object is moving in.
	private int size; // Size of the object.
	
	public MovableGameObject() { // Constructor for MovableGameObject.
	
		setSpeed(getRandom(5) + 5); // Speed will be between 5 and 10.
		setDirection(getRandom(359)); // Direction can be any angle between 0 and 359.
	...
	public void setDirection(int dir) {
		// Adjusting direction to always be between 0 and 359 degrees
		  while (dir < 0) {
	            dir += 360;
	        }
	        dir %= 360;
